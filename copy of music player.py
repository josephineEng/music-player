...
#was trying to put background image as an animation
'''
top=Tk()


C=Canvas(top,bg="green",height=250,width=300)
filename=PhotoImage(file="D:/background/animation.MOV")
...
Label1 = tk.Label(master,text="CUSTOMISE MUSIC PLAYER",font=("calibri",15),fg="red")
